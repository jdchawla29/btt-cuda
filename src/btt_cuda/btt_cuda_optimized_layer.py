...
class BTTFunctionOptimized(torch.autograd.Function):
    ...
    def forward(ctx, x, W1, W2, shapes):
        ...
        # Call optimized CUDA (cuBLAS batch) forward
        out, out1 = forward_optimized(x, W1, W2, m1, m2, n1, n2, r1, r2)
    ...
    def backward(ctx, grad_output):
        ...
        grad_input, grad_W1, grad_W2 = backward_optimized(grad_output, x, W1, W2, out1, m1, m2, n1, n2, r1, r2)
...
class BTTLayerOptimized(nn.Module):
    """Block Tensor-Train Layer with optimized CUDA implementation using batched cuBLAS operations"""
    ...
    def forward(self, x):
        ...
        return BTTFunctionOptimized.apply(x, W1, W2, self.shapes)

    def extra_repr(self) -> str:
        return f'in={self.m1}×{self.m2}, out={self.n1}×{self.n2}, rank={self.tt_rank}, optimized=True'